...
func TestInvokePanelButtonConfigureCreatesPendingPlanWithoutWriting(t *testing.T) {
	...
	input := `{"contractVersion":"1.0","requestId":"req-panel-config-plan","locale":"zh-CN","utterance":"把客厅面板第一个按键绑定回家情景","intent":"panel.button.configure","targets":[{"entityType":"device","id":"panel-1"}],"parameters":{"houseId":"200171","buttons":[{"id":"btn-1","keyValue":1,"resId":"scene-1","resType":6,"visible":1,"accessToken":"must-drop"}]}}`
