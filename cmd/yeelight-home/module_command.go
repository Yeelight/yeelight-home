...
func moduleParameterFlags() map[string]string {
	return map[string]string{
		...
		"action-name":         semantic.FieldActionName,
		"add-device-ids":      semantic.FieldAddDeviceIDs,
		"add-device-names":    semantic.FieldAddDeviceNames,
		...
		"node-ids":            semantic.FieldNodeIDs,
		"node-type":           semantic.FieldNodeType,
		"operation":           semantic.FieldOperation,
		...
		"properties-json":     semantic.FieldProperties,
		"payload-json":        semantic.FieldPayload,
		"flow-json":           semantic.FieldFlow,
		"event-id":            semantic.FieldEventID,
		...
		"remove-device-ids":   semantic.FieldRemoveDeviceIDs,
		"remove-device-names": semantic.FieldRemoveDeviceNames,
...
func normalizeLightModuleTarget(parameters map[string]any) {
	...
	switch {
	case firstRequestString(parameters, semantic.FieldAreaID) != "":
